  ...
  return (
    <header className="bg-bottle-green py-1">
      <div className="container text-center d-flex align-items-center justify-content-center">
        ...
        <h1 className="text-dark display-4" style={{ fontFamily: 'Roboto, sans-serif', textShadow: '2px 2px 2px rgba(0, 0, 0, 0.3)', color: '#fff' }}>Academic Analysis: Too Ambitious List</h1>
        </div>
      </div>
    </header>
  );
